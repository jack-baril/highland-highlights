...
APP_ICON_PATH = "assets/img/highland-hawk-logo.png"
...
WEATHER_API_LOCATION = "gilbert"
WEATHER_API_URL = f"https://api.weatherapi.com/v1/current.json?key={WEATHER_API_KEY}&q={WEATHER_API_LOCATION}"
